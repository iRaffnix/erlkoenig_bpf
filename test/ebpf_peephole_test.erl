...
p1_removes_self_mov32_test() ->
    Code = ebpf_insn:assemble([
        ...
        ebpf_insn:mov32_reg(2, 2),      %% redundant
        ebpf_insn:exit_insn()
    ]),
    Opt = ebpf_peephole:optimize(Code),
    Expected = ebpf_insn:assemble([
...
p2_stxdw_ldxdw_forwarding_test() ->
    ...
    Expected = ebpf_insn:assemble([
        ebpf_insn:mov64_imm(1, 42),
        ebpf_insn:mov64_reg(2, 1),      %% forwarded
        ebpf_insn:mov64_reg(0, 2),
        ebpf_insn:exit_insn()
    ]),
    ?assertEqual(Expected, Opt).
...
p2_different_offset_no_forward_test() ->
    ...
    Code = ebpf_insn:assemble([
        ebpf_insn:stxdw(10, -8, 1),
        ebpf_insn:ldxdw(2, 10, -16),    %% different offset!
        ebpf_insn:exit_insn()
    ]),
    Opt = ebpf_peephole:optimize(Code),
    ?assertEqual(Code, Opt).
...
p2_different_base_no_forward_test() ->
    ...
    Code = ebpf_insn:assemble([
        ebpf_insn:stxdw(10, -8, 1),
        ebpf_insn:ldxdw(2, 9, -8),      %% different base!
        ebpf_insn:exit_insn()
    ]),
    Opt = ebpf_peephole:optimize(Code),
    ?assertEqual(Code, Opt).
...
p3_double_store_same_offset_test() ->
    ...
    Code = ebpf_insn:assemble([
        ebpf_insn:stxdw(10, -8, 1),
        ebpf_insn:stxdw(10, -8, 2),     %% overwrites first
        ebpf_insn:exit_insn()
    ]),
    Opt = ebpf_peephole:optimize(Code),
    Expected = ebpf_insn:assemble([
...
p3_works_with_jumps_test() ->
    ...
    Code = ebpf_insn:assemble([
        ebpf_insn:stxdw(10, -8, 1),
        ebpf_insn:stxdw(10, -8, 2),
        ebpf_insn:jeq_imm(2, 0, 1),     %% jump present
    ...
    Opt = ebpf_peephole:optimize(Code),
    Expected = ebpf_insn:assemble([
        ebpf_insn:stxdw(10, -8, 2),     %% first store eliminated
...
p1_disabled_with_jumps_test() ->
    ...
    Code = ebpf_insn:assemble([
        ebpf_insn:mov64_reg(1, 1),       %% would be removed without jumps
...
combined_p1_p2_test() ->
    ...
    Code = ebpf_insn:assemble([
        ebpf_insn:mov64_imm(1, 42),
        ebpf_insn:mov64_reg(1, 1),       %% P1: redundant
        ebpf_insn:stxdw(10, -8, 1),
        ebpf_insn:ldxdw(2, 10, -8),      %% P2: forwarded
        ebpf_insn:mov64_reg(0, 2),
        ebpf_insn:exit_insn()
    ]),
    Opt = ebpf_peephole:optimize(Code),
    Expected = ebpf_insn:assemble([
        ebpf_insn:mov64_imm(1, 42),
        ebpf_insn:mov64_reg(2, 1),       %% P2 result
        ebpf_insn:mov64_reg(0, 2),
        ebpf_insn:exit_insn()
    ]),
    ?assertEqual(Expected, Opt).
...
correctness_p1_execution_test() ->
    ...
    Code = ebpf_insn:assemble([
        ...
        ebpf_insn:mov64_reg(2, 2),       %% redundant
...
correctness_p3_execution_test() ->
    Code = ebpf_insn:assemble([
        ...
        ebpf_insn:mov64_imm(2, 42),
        ebpf_insn:stxdw(10, -8, 1),     %% dead store
        ebpf_insn:stxdw(10, -8, 2),     %% overwrites
        ebpf_insn:ldxdw(0, 10, -8),
        ebpf_insn:exit_insn()
    ]),
    Opt = ebpf_peephole:optimize(Code),
...
ld_map_fd_not_broken_test() ->
    ...
    Code = ebpf_insn:assemble([
        ebpf_insn:ld_map_fd(1, 0),       %% 16-byte insn
        ebpf_insn:mov64_reg(0, 1),
        ebpf_insn:exit_insn()
    ]),
    Opt = ebpf_peephole:optimize(Code),
