...
xval_16_all_tcp_dropped_empty_map_test_() ->
    {timeout, 30,
        with_port(fun(Port) ->
            ...
            Results = xval_sequence(
                Port,
                Bin,
                [Pkt80, Pkt443, Pkt9999],
                MapSpecs
            ),
