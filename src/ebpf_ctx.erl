...
-module(ebpf_ctx).
-moduledoc """
Context struct layout definitions for BPF program types.
...
-doc "Look up a context field by program type and field name. Returns {ok, Offset, Size} or {error, unknown_field}.".
...
-doc "Return all context fields for a program type. Each entry is {Name, Offset, SizeInBytes}.".
