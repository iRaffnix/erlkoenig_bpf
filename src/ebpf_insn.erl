...
ld64_imm(Dst, Imm) ->
    ...
    <<?OP_LD_IMM64, (0 bsl 4 bor Dst), 0:16/signed-little, Lo:32/signed-little, 0:8, 0:8,
        0:16/signed-little, Hi:32/signed-little>>.

-spec ld_map_fd(reg(), integer()) -> insn().
ld_map_fd(Dst, MapFd) ->
    <<?OP_LD_IMM64, (?BPF_PSEUDO_MAP_FD bsl 4 bor Dst), 0:16/signed-little, MapFd:32/signed-little,
...
decode(
    <<?OP_LD_IMM64, SrcDst, Off:16/signed-little, ImmLo:32/signed-little, 0, 0, 0:16/little,
        ImmHi:32/signed-little>>
) ->
...
-doc """
Rewrite BPF_PSEUDO_MAP_FD (src=1) to src=0 in all LDDW instructions.
